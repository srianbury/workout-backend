...
async function startServer() {
  ...
  await mongoose.connect(
    `${process.env.MONGO_DB_PROTOCOL_SCHEME}://${process.env.MONGO_DB_USERNAME}:${process.env.MONGO_DB_PASSWORD}@${process.env.MONGO_DB_HOST}/?retryWrites=true&w=majority`,
    {
